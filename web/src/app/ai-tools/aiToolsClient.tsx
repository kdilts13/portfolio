...
// TODO: Replace these with your redacted resume + fake job description.
const DEMO_RESUME_TEXT = `DEMO (redacted) resume goes here.

TODO: Replace with your redacted resume text.`;

const DEMO_JOB_DESCRIPTION = `DEMO job description goes here.

TODO: Replace with your fake job description.`;
...
export default function AiToolsClient() {
  ...
  function loadDemo() {
    ...
    setOutput(
      `# Demo output (cached)\\n\\n` +
        `This is a placeholder demo response.\\n\\n` +
        `TODO: Replace with a real cached response so visitors can try the tool instantly without using OpenAI tokens.`,
    );
